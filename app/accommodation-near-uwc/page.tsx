...
export const metadata: Metadata = {
  title: { absolute: "Accommodation Near UWC | Short & Medium Stays" },
  description:
    "Guest accommodation near the University of the Western Cape (UWC) in Bellville for exchange students, visiting researchers, short courses, graduations and family visiting students. Ensuite rooms, WiFi, secure parking.",
  alternates: {
    canonical: "https://www.60onkosmos.co.za/accommodation-near-uwc",
  },
  keywords: [
    "accommodation near uwc",
    "guest accommodation uwc bellville",
    "uwc visiting student accommodation",
    "uwc exchange student housing",
    "accommodation for uwc graduation",
    "uwc visiting lecturer accommodation",
  ],
  openGraph: {
    title: "Accommodation Near UWC | Short & Medium Stays",
    description:
      "Guest accommodation near UWC in Bellville for exchange students, visiting researchers, short courses, graduations and family visiting students.",
    url: "https://www.60onkosmos.co.za/accommodation-near-uwc",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Guest Accommodation Near UWC",
      },
    ],
  },
}
...
const faqs = [
  {
    question: "Is this a UWC campus residence or NSFAS-accredited property?",
    answer:
      "No. 60 on Kosmos is an independent guesthouse, not a UWC campus residence and not an NSFAS-accredited student property. We are not a substitute for full academic-year residence — we're a practical option for shorter stays of a few weeks to a few months.",
  },
  {
    question: "How far is 60 on Kosmos from UWC?",
    answer:
      "60 on Kosmos is approximately 5–8 minutes from UWC by car, subject to traffic.",
  },
  {
    question: "Who typically stays here for UWC-related visits?",
    answer:
      "Exchange and research students, visitors on short university programmes, people attending graduations, seminars, conferences or training, visiting lecturers and staff, and parents or family visiting students at UWC.",
  },
  {
...
export default function AccommodationNearUwcPage() {
  const breadcrumbItems = [
    { name: "Home", url: "/" },
    { name: "Accommodation Near UWC", url: "/accommodation-near-uwc" },
  ]
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500 flex-wrap">
            ...
            <li className="text-gray-900 font-medium">Accommodation Near UWC</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="relative bg-gray-900 py-16 md:py-24">
        <div className="absolute inset-0">
          <Image
            ...
            alt="60 on Kosmos guest accommodation near UWC"
            fill
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-sage-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              <span>Near the University of the Western Cape</span>
            </div>
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-6 text-balance">
              Guest Accommodation Near UWC
            </h1>
            <p className="text-lg sm:text-xl text-gray-300 mb-8 text-pretty max-w-3xl mx-auto">
              Private ensuite rooms in Bellville, approximately 5–8 minutes from UWC by car, subject to traffic. Built
              for short and medium stays — not a campus residence or NSFAS-accredited property.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a
                  href="https://wa.me/27745245703?text=Hi%2C%20I%27m%20looking%20for%20accommodation%20near%20UWC"
                  target="_blank"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-6">
            We're not trying to be a permanent student residence — our real markets around UWC are shorter, defined
            stays:
          </p>
          ...
          <p className="text-sm text-gray-500 mt-6">
            Looking specifically for accommodation for a contractor or project team working near UWC? See our{" "}
      ...
      <section className="py-16 bg-sage-600 text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-100 mb-8">
            Tell us your arrival date and how long you need to stay near UWC, and we&apos;ll confirm availability and
            rates.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <section className="py-10 bg-white border-t">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap gap-4 items-center justify-center text-sm">
            <Link href="/accommodation-near-cput" className="inline-flex items-center gap-2 text-sage-600 hover:text-sage-700 font-medium">
