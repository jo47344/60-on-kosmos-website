    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8 text-center">Why Choose 60 on Kosmos for Northern Suburbs Teams?</h2>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold mb-2">Central Hub for All Northern Suburbs Sites</h3>
                    <p className="text-gray-600">
                      Strategic location gives quick access to Parow, Stikland, Goodwood, Kuils River, and surrounding areas.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold mb-2">Flexible &amp; Scalable Accommodation</h3>
                    <p className="text-gray-600">
                      From 5-person crews to large shutdowns. All room types available, customized pricing and logistics.
                    </p>
                  </div>
                </div>
              </CardContent>
