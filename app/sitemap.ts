...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    // Student/Medical pages - secondary market
    { url: "uwc-student-accommodation", priority: 0.8, freq: "weekly" as const },
    { url: "cput-accommodation", priority: 0.8, freq: "weekly" as const },
    { url: "tygerberg-hospital-accommodation", priority: 0.8, freq: "weekly" as const },
    ...
    { url: "near-uwc-bellville", priority: 0.75, freq: "weekly" as const },
    { url: "near-cput-bellville", priority: 0.75, freq: "weekly" as const },
    { url: "accommodation-near-tygerberg-hospital", priority: 0.75, freq: "weekly" as const },
    { url: "accommodation-near-bellville-station", priority: 0.7, freq: "monthly" as const },
    { url: "bellville-south-guesthouse", priority: 0.7, freq: "monthly" as const },
