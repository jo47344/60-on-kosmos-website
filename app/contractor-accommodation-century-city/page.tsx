...
export const metadata: Metadata = {
  ...
  description:
    "Corporate and project team accommodation near Century City and Canal Walk. 5 private ensuite rooms, up to 8 guests, weekly/monthly rates, company invoicing.",
  alternates: {
  ...
  openGraph: {
    title: "Contractor Accommodation Near Century City | 60 on Kosmos",
    description:
      "Corporate and project team accommodation near Century City and Canal Walk. 5 private ensuite rooms, up to 8 guests.",
...
export default function CenturyCityPage() {
  ...
  const schemaData = {
    ...
    description:
      "Private-ensuite accommodation for contractor and project teams working near Century City and Canal Walk. 4 room types, suitable for teams of up to 8 guests. Secure parking, WiFi, weekly and monthly rates, company invoicing.",
    address: {
      "@type": "PostalAddress",
