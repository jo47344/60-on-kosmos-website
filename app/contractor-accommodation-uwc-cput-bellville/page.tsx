...
export default function UwcCputBellvillePage() {
  ...
  const schemaData = {
    ...
    description:
      "Private-ensuite accommodation for company staff, trainers and project teams working near UWC and the CPUT Bellville campus. 4 rooms, suitable for teams of up to 8 guests. Secure parking, WiFi, weekly and monthly rates, company invoicing.",
    address: {
      "@type": "PostalAddress",
