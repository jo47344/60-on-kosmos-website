...
export default function CPUTAccommodationPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline">
                <a href="https://wa.me/27745245703?text=Hi%2C%20I%27m%20interested%20in%20CPUT%20accommodation">
                  WhatsApp Us
                </a>
              </Button>
            </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold text-lg">4.5km to CPUT</h3>
                </div>
                <p className="text-gray-600">8-minute drive to campus</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-8">Our Location Near CPUT</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">Also close to UWC Bellville campus</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
      ...
      <section className="py-16 bg-sage-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Book Your CPUT Accommodation?</h2>
          <p className="text-xl mb-8 text-sage-50">
            Secure your room near CPUT campus today. Limited availability during peak academic periods.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
