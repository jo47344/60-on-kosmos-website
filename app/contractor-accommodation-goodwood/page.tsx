...
export const metadata: Metadata = {
  title: "Contractor Accommodation Goodwood | From R530/Night | Near Goodwood Industrial",
  description:
    "Affordable contractor accommodation near Goodwood. 12 minutes drive. Standard R530, Plus R580, Double R620, Triple R750. Weekly cleaning, secure parking, WiFi included. Book direct!",
  alternates: {
    canonical: "https://60onkosmos.co.za/contractor-accommodation-goodwood",
  },
  keywords: [
    "contractor accommodation Goodwood",
    "Goodwood worker accommodation",
    "monthly accommodation Goodwood",
    "construction crew housing Goodwood",
  ],
  openGraph: {
    title: "Contractor Accommodation Near Goodwood | From R530/Night",
    description: "12 minutes from Goodwood. Self-catering rooms for contractors & work crews.",
    url: "https://60onkosmos.co.za/contractor-accommodation-goodwood",
    type: "website",
  },
}

export default function ContractorAccommodationGoodwoodPage() {
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "LodgingBusiness",
    name: "60 on Kosmos - Contractor Accommodation Near Goodwood",
    description: "Affordable contractor accommodation near Goodwood for construction workers and project teams.",
    address: {
      "@type": "PostalAddress",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gray-900 py-16 md:py-24">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Contractor Accommodation Near Goodwood"
            fill
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-sage-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              <span>12 Minutes from Goodwood</span>
            </div>
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-6">Contractor Accommodation Near Goodwood</h1>
            <p className="text-xl text-gray-300 mb-4">
              Affordable self-catering rooms for contractors working in Goodwood.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Button asChild size="lg" className="bg-sage-600 hover:bg-sage-700 text-white px-8 py-6 text-lg">
                <a href="https://wa.me/27745245703?text=Hi%2C%20I%27m%20looking%20for%20contractor%20accommodation%20near%20Goodwood">
                  WhatsApp Us
                </a>
              </Button>
              <Button
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-sage-50 rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Easy Access to Goodwood & Surrounds</h2>
            <div className="grid md:grid-cols-4 gap-6">
              <div>
                <p className="text-3xl font-bold text-sage-600">12 min</p>
                <p className="text-gray-600">to Goodwood</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-sage-600">10 min</p>
                <p className="text-gray-600">to Parow</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-3xl font-bold text-sage-600">15 min</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Full kitchen to save on meals</p>
              </div>
            </div>
            <div className="flex gap-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Fresh linen and cleaning included</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Easy access to Goodwood, Parow & N1</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-sage-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Working in Goodwood? Book Today</h2>
          <p className="text-sage-100 text-lg mb-8">Affordable contractor accommodation just 12 minutes away.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-white text-sage-700 hover:bg-gray-100 px-8 py-6 text-lg">
              <a href="https://wa.me/27745245703?text=Hi%2C%20I%20need%20contractor%20accommodation%20near%20Goodwood">
                WhatsApp Now
              </a>
            </Button>
            <Button
